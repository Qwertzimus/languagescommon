 ...
 */
public abstract class CommonMCMethodSymbol<U extends MCTypeSymbol, T extends MCTypeReference<? extends U>, S extends MCFieldSymbol>
        extends CommonScopeSpanningSymbol implements MCMethodSymbol {
    ...
    public CommonMCMethodSymbol(String name, MCMethodSymbolKind kind) {
        super(name, kind);
    }
